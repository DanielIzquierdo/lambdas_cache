...
def lambda_handler(event, context):
    month_customers_vs_until_yesterday = None
    ...
    if business and date_filter:
        month_customers_vs_until_yesterday = r.get(business + '-' + date_filter + '-customer_vs')

    return {
        "res": month_customers_vs_until_yesterday
    }
